...
a leap year and return true if it is a leap year, otherwise return false.
...
public class C05_LeapYear {
    public static void main(String[] args) {
        boolean isLeapYear = isLeapYear(2016);
        System.out.println("Is Leap Year : " + isLeapYear);
        isLeapYear = isLeapYear(0);
        System.out.println("Is Leap Year : " + isLeapYear);
    }
