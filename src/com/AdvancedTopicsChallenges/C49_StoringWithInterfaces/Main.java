...
2.  Player (class)
    ...
    -  A constructor that accepts a String (name) and two ints (hitPoints and strength). It initialises
            name, hitPoints and strength with the newly passed in values. It initialises weapon with
    ...
    -  And eleven methods:
        ...
        -  toString(), Players overriding toString() method. It takes no arguments and returns a String
...
public class Main {
    public static void main(String[] args) {
        Player player = new Player("Tim", 100, 10);
        Monster monster = new Monster("Troll",1800,3);
        monster.read(List.of("Troll", "1790", "10"));
        System.out.println("Monster took damage - " + monster);
        monster.read(List.of("Troll", "1690", "10"));
        System.out.println("Monster took critical damage - " + monster);
    }
}
